...
- (void)createCurrentView {
    ...
    [self.currentTextInfoView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.edges.insets(UIEdgeInsetsZero);
    }];
}
...
- (void)createHidenView {
    ...
    [self.hidenView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.mas_equalTo(self).multipliedBy(3);
    }];
    ...
    [self.hiddenTextInfoView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.edges.insets(UIEdgeInsetsZero);
    }];
}
